...
resource "vault_generic_secret" "roboshop-dev-cart" {
  ...
  data_json = <<EOT
{
"REDIS_HOST":   "redis-dev.masdevops.online",
...
"USER_HOST" : "user-dev.masdevops.online",
"USER_PORT" : 8080,
"AMQP_HOST" : "rabbitmq-dev.masdevops.online",
"AMQP_USER" : "roboshop",
...
{
"MONGO" : "true",
"REDIS_URL" : "redis://redis-dev.masdevops.online:6379",
"MONGO_URL" : "mongodb://mongodb-dev.masdevops.online:27017/users"
}
EOT
}
